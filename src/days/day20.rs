...
pub fn solve(input: &str) -> Solution {
    ...
    let p1_result = bfs(&State::from_tiles(tiles), State::successors, State::all_laid_out).expect("No solution pt 1");
    let p1 = p1_result[p1_result.len()-1].corner_tiles_product();
